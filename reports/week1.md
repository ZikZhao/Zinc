...
#### 6. Next Steps
	...
	1. Template definition and explicit instantiation
	1. Refactor operator system
	1. Built-in types
	1. Mutability
	1. Borrow checker (lexical and statement-level lifetimes)
	1. Static lock order analysis (lock ranking with escape hatch)
